...
async function main() {
  ...
  const users = [
    { email: 'admin@example.com', name: 'عبدالله سامي', role: 'ADMIN' as const },
    { email: 'fatima@example.com', name: 'فاطمة علي', role: 'USER' as const },
    { email: 'mohamed@example.com', name: 'محمد حسن', role: 'USER' as const },
    { email: 'sara@example.com', name: 'سارة إبراهيم', role: 'USER' as const },
    { email: 'omar@example.com', name: 'عمر خالد', role: 'USER' as const },
    { email: 'nora@example.com', name: 'نورة الفالح', role: 'ADMIN' as const },
  ];
